...
const UncontectedDetails = () => {
  ...
  return (
    <>
    <div className="w-10 h-10 rounded-full flex items-center justify-center text-white font-semibold text-sm">UncontectedDetails</div>
...
export default UncontectedDetails;
